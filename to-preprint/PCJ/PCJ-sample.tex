...
single BNs can be performed using the command line
program \texttt{bonesis-reprogramming}, provided alongside the
\texttt{bone\-sis} Python package. We detail its usage in each case.
...
use \texttt{mpbn} (\href{https://github.com/bnediction/mpbn}{https://github .com/bnediction/mpbn}) to analyze
...
\end{small}
\medskip
The program \texttt{bonesis-reprogramming} can perform P2
